function nextX = PointsUpdate(system, X, u, y, noise)
% PointsUpdate - Function encapsulating the update phase of a
...
% 
% Syntax:  
%    nextX = PointsUpdate(system, X, u, y, noise)
%
% Inputs:
...
%
% Outputs:
%    nextX - Points with all values that can result in the
...
%    X = PointsUpdate(system, X, ones(2,1), 2*ones(2,1), noise)
%
...
Y = PointsLinMap(-system.N,noise,y - system.D * u);

nextX = PointsIntersect(system.C,X,Y);
