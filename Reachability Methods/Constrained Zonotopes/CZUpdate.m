function nextX = CZUpdate(system, X, u, y, noise)
...
% 
% Syntax:  
%    nextX = CZUpdate(system, X, u, y, noise)
%
% Inputs:
...
%
% Outputs:
%    nextX - Constrained Zonotope with all values that can result in the
...
%    X = CZUpdate(system, X, ones(2,1), 2*ones(2,1), noise)
%
...
Y = CZLinMap(-system.N,noise,y - system.D * u);

nextX = CZIntersect(system.C,X,Y);
