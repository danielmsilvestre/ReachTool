function c = CZCenter(X)
% CZCenter - Function that calculates the center of a Constrained Zonotope
...
%    X.A = zeros(0,m);
%    X.b = zeros(0,1);
%    c = CZCenter(X) % zero vector given that there are no constraints
%
