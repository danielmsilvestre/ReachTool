function system = motorPosition(parameters, Ts)
% motorPosition - Outputs the discrete dynamical system corresponding to a
% model of a motor position using ZOH with sampling time Ts.
%   c2d(ss(A,B,C,D)) with :
% 
%   A = [0 1 0
%        0 -b/J K/J
...
%
% Syntax:  
%    system = motorPosition(parameters, Ts)
%
% Inputs:
...
%
% Example: 
%    system = motorPosition(struct('J', 0.01, 'b', 0.1, 'K', 0.01, 'R', 1, 'L', 0.5), 0.1)
%
